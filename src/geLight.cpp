...
geSpotLight::geSpotLight(string lightID, int openGLid, bool iEnable, gePoint iLocation, geColor iAmbient, geColor iDiffuse, geColor iSpecular, GLfloat iSpotAngle, GLfloat iSpotExponent,
