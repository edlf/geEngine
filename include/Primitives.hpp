...
public:
    Triangle(GLdouble inX1, GLdouble inY1, GLdouble inZ1, GLdouble inX2,
...
public:
    Cylinder(GLdouble iBase, GLdouble iTop, GLdouble iHeight,
...
public:
    Patch(unsigned int iorder, unsigned int ipartsU, unsigned int ipartsV,
...
public:
    WaterLine(std::string& hmap, std::string& tmap, std::string& fshader,
            std::string& vshader);
    virtual ~WaterLine();
